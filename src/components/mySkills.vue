<template>
    <main class="md:px-28 px-6">
        ...
        <div class="">
            ...
            <div class="">
                <div class="skills">
                    <div class="grid grid-cols-2 md:grid-cols-6 space-y-4 mx-auto justify-center items-center">
                        ...
                        <div class="third" data-aos="fade-in">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-28 h-28 object-cover rounded-full p-2 border-4 border-purple-600"
                                ...
                                <path fill="#33a9dc" d="m64.001 119.072l29.439-8.162l6.926-77.591H64.001z" />
                                <path fill="#fff"
