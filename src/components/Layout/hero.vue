  ...
  <section class="mt-28 dark:bg-gray-900">
    <div
      ...
      <div class="mr-auto place-self-center lg:col-span-7">
        <span
          class="bg-purple-600 text-white text-xs font-medium me-2 px-2.5 py-0.5 mb-8 rounded dark:bg-green-900 dark:text-green-300">Software
          Developer</span>
        <h1
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex text-center">
        <div class="img">
          <img src="@/assets/img/sam-3.jpg"
            class="w-96 h-96 object-cover rounded-full object-cover border glow-neon-button border-purple-600"
            alt="mockup">

          <div class="icon flex justify-center items-center py-4 text-center mx-auto gap-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" class="text-white" viewBox="0 0 14 14">
              <g fill="none">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" class="text-white" viewBox="0 0 24 24">
